...
class HomeViewModel(
    ...
    companion object {
        const val PLUGIN_GEOKORI = "org.cwcc.open.plugin.geokori"
        const val PLUGIN_EXAMPLE = "com.combo.plugin.sample.example"
        const val PLUGIN_SETTING = "org.cwcc.open.plugin.setting"
    }
            ...
            combine(
                ...
                updateState {
                    copy(
                        ...
                        guideEntryClass = PluginManager.getPluginInstance(PLUGIN_GEOKORI),
